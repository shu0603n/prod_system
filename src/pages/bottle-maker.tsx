  ...
  return (
    <>
      <Head>
        ...
        {/* canvas height fix: height:100% requires a defined parent height */}
        <style>{`
      ...
      <main className="main">
        ...
        <div className="preview">
          ...
          <div id="bottleContainer" className="bottle-container preview__bottle-container">
              ...
              <div className="control__box">
                <div className="control__box-inner">
                  <ul className="control__list">
                    <li className="control__txt">・テンプレートから画像を作成</li>
              ...
              <div className="control__box">
                <div className="control__box-inner">
                  <div className="control__radio-list">
                    {[
                      "gold", "silver", "pink", "white", "black", "red",
                      "purple", "pastelPink", "pastelBlue", "yellow", "blue",
                      "orange", "green", "pastelPurple", "bronze",
                    ].map((color) => (
            ...
            <div className="control__inner">
              ...
              <div className="control__box">
                <div className="control__box-inner">
                  <div className="control__radio-list">
                    {[
                      { value: "label-gold", src: "label-gold", alt: "label-gold", defaultChecked: true },
                      { value: "label-black", src: "label-black", alt: "label-black", defaultChecked: false },
                      { value: "label-silver", src: "label-white", alt: "label-white", defaultChecked: false },
                      { value: "label-pink", src: "label-pink", alt: "label-pink", defaultChecked: false },
